 ...
 * 
 * @author paseihon
 * Este proyecto ha sido realizado por pascal. 
 * Un saludo
 */
        ...
        for (Rectangle cell : cells) {
            ...
            for (int pl = 0; pl < bs.maxPlayers; pl++) {
                if (bs.players.get(pl).getPosition() == cellnos[i]) {
                    draw_player_position(g2d, pl, cell, cellWidth, cellHeight);
                }
            }
 ...
 */
    private void draw_player_position(Graphics2D g2d, int pl, Rectangle cell, int cellWidth, int cellHeight) {
